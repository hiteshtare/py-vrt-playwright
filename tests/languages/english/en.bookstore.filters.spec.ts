...
test.describe("Bookstore - Filters check", () => {
  ...
  test("#1 Photos of Babaji", async ({ page }) => {
    ...
    await vrt.trackPage(page, "#1.1 Dashboard - Photos Category", trackOptions);
    ...
    await vrt.trackPage(page, "#1.2 Photos of Babaji", trackOptions);
  });

  test("#2 Books by Sri Sri Daya Mata", async ({ page }) => {
    ...
    await vrt.trackPage(page, "#2.1 Dashboard - Books Category", trackOptions);
    ...
    await vrt.trackPage(page, "#2.2 Books by: Sri Sri Daya Mata", trackOptions);
    ...
    await vrt.trackPage(
      page,
      "#2.3 Books by: Sri Sri Daya Mata - Hindi",
      trackOptions,
    );
  });
  ...
  test("#4 Audio by Sri Sri Mrinalini Mata", async ({ page }) => {
    ...
    await vrt.trackPage(page, "#4.1 Dashboard - Audio Category", trackOptions);
    ...
    await vrt.trackPage(
      page,
      "#4.2 Audio by: Sri Sri Mrinalini Mata",
      trackOptions,
    );
  });
